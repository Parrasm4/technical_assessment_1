...
var = inStock
if (inStock >= 1) {
    inStock = "I'm going to eat some" + food + "!";
} else {inStock = "We need to get some more" + food + "."};
...
if (isFavorite === true) {
    isFavorite = "My favorite food is" + food + "!";
} else {inStock = "I recently ate" + food + "."};
...
var vegetables = ["Cucumber", "Carrot", "Celery", "Potatoe", "Broccoli"];
...
// different fruits.
var fruits = ["Strawberry", "Apple", "Grape", "Pear", "Mango", "Kiwi", "Orange"];
